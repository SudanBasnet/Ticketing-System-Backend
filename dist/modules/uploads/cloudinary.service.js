...
const isConfigured = () => Boolean(config.CLOUDINARY_CLOUD_NAME && config.CLOUDINARY_API_KEY && config.CLOUDINARY_API_SECRET);
...
export const uploadBuffer = async (file, options) => {
    configureCloudinary();
